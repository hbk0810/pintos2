               ...
               thread_func *function, void *aux) 
{
  ...
  /* Add to run queue. */
  thread_unblock (t);
  /* Check whether current thread is prior to created thread */
  isYield();
...
thread_unblock (struct thread *t) 
{
  ...
  /* Replace round robin function to priority insert function*/
  /*list_push_back (&ready_list, &t->elem);*/
  list_insert_ordered(&ready_list, &t->elem, pCompare, NULL);
...
thread_yield (void) 
{
  ...
  if (cur != idle_thread) 
    ...
    /*list_push_back (&ready_list, &cur->elem);*/
	  list_insert_ordered(&ready_list, &cur->elem, pCompare, NULL);
...
/* Newly implemented function which determines whether the current thread should be yielded due to its priority change */
void isYield(void) {
...
/* Newly implemented function which compare the priority of a thread with another thread to be used in list_insert_ordered() function */
bool pCompare(const struct list_elem* x, const struct list_elem* y, void* aux UNUSED) {
